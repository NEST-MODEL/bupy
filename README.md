...
| 3. Ядро | Онбординг, питомцы, dashboard, вакцинации, лекарства, календарь | ⏳ |
| 4. Остальное | OCR паспорта, Bupy Help, клиники (OSM), напоминания, экспорт, документация, финальный zip | ⏳ |

Разделы «Главная», «Календарь», «Здоровье», «Помощник» пока показывают пустые состояния — без выдуманных данных.
